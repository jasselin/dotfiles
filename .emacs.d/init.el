...
(setq initial-scratch-message nil) ; remote scratch buffer message
...
(setq visible-bell t)    ; visual bell instead of beeping sound

;; Disable prompt for:
;; Symbolic link to Git-controlled source file; follow link?
(setq vc-follow-symlinks nil);; Maximize window on startup

(add-hook 'window-setup-hook 'toggle-frame-maximized t)

;; Custom location for custom variables file
